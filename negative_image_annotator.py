...
Description: This file adds annotations to negative files in .xml files and stores them in the image_data directory.
             ...
             ### After this code was run I moved the negative images to image_data and deleted
                 the seperate directory containing my negative images called to_be_labeled     ###
References: Stqack Overflow and Python Docs.
Sources: Stack Overflow https://stackoverflow.com/questions/3605680/creating-a-simple-xml-file-using-python
